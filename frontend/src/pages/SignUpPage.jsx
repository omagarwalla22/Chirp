...
const SignUpPage = () => {
  ...
  const validateForm = () => {
    ...
    if (formData.password.length < 6) return toast.error("Password needs at least 6 characters");
    return true;
  };
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center mb-8">
            <div className="flex flex-col items-center gap-2 group">
              ...
              <p className="text-base-content/60">Start chatting with your network</p>
            </div>
          </div>
      ...
      <AuthImagePattern
        ...
        subtitle="Connect with friends and keep your chats flowing."
      />
    </div>
  );
};
